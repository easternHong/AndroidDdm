...
public final class NullOutputReceiver implements IShellOutputReceiver {
    ...
    /* (non-Javadoc)
     * @see android.ddmlib.adb.IShellOutputReceiver#addOutput(byte[], int, int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see android.ddmlib.adb.IShellOutputReceiver#flush()
     */
    @Override
    public void flush() {
    }
    ...
    /* (non-Javadoc)
     * @see android.ddmlib.adb.IShellOutputReceiver#isCancelled()
     */
    @Override
