...
import android.ddmlib.Log.LogLevel;
import android.me.IPidFilter;
...
final class MonitorThread extends Thread {
    ...
    private IPidFilter iPidFilter;

    public void setPidFilter(IPidFilter iPidFilter) {
        this.iPidFilter = iPidFilter;
    }
    ...
    private void processClientActivity(SelectionKey key) {
        ...
        try {
            ...
            client.read();
            if (iPidFilter != null && !iPidFilter.pickPid(client.getClientData().getPid())) {
                return;
            }
            /*
