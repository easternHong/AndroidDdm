...
package android.ddmlib;

import android.annotations.NonNull;
import android.annotations.Nullable;
import android.annotations.VisibleForTesting;
import android.annotations.concurrency.GuardedBy;
import android.ddmlib.log.LogReceiver;
...
final class Device implements IDevice {
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getSerialNumber()
     */
    @NonNull
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getState()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getProperties()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getPropertyCount()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getProperty(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#isOnline()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#isEmulator()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#isOffline()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#isBootLoader()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getSyncService()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#getFileListingService()
     */
    @Override
    ...
    /**
     * Implementation of {@link android.ddmlib.MultiLineReceiver} that can receive a
    ...
    /*
     * (non-Javadoc)
     * @see android.ddmlib.IDevice#reboot()
     */
    @Override
