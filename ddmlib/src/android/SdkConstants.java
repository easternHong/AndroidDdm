...
public final class SdkConstants {
    ...
    public static final String CLASS_MOCK_VIEW = "android.layoutlib.bridge.MockView"; //$NON-NLS-1$
    ...
    public static final String GRADLE_PLUGIN_NAME = "android.tools.build:gradle:";
    ...
    public static final String SUPPORT_LIB_ARTIFACT = "android.support:support-v4";
    public static final String APPCOMPAT_LIB_ARTIFACT = "android.support:appcompat-v7";
    ...
    // Data Binding MISC
    public static final String DATA_BINDING_LIB_ARTIFACT = "android.databinding:library";
